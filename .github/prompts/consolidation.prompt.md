...
- ✅ `investment-management.instructions.md` - General investment management standards
...
- ✅ `security-analysis.instructions.md` - **ENHANCED** with Z-Score/F-Score frameworks
...
- ✅ `portfolio-construction.prompt.md` - Portfolio optimization workflows
- ✅ `investment-research.prompt.md` - Research and due diligence processes
